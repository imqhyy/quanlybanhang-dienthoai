...
public class NhanVien extends ConNguoi {
    ...
    public String getStringLuong() {
        ...
        /*
         * DecimalFormat: Lớp chuyên định dạng số (tiền, phần trăm, số thập phân)
         * getInstance(vietNam): Lấy công cụ định dạng mặc định của Việt Nam
         * Ví dụ: 1.234,56 (không dùng ở VN) → sẽ thành 1.234
         * 
         * (DecimalFormat): Ép kiểu → vì getInstance() trả về NumberFormat, cần ép về
         * DecimalFormat để dùng applyPattern
         */
